...
public class UserInfoUtil {
    ...
    // 1.获取code的请求地址
    public  String Get_Code = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=%s&redirect_uri=%s&response_type=code&scope=%s&state=STAT&connect_redirect=1#wechat_redirect";
    // 替换字符串
    ...
    public  String Web_access_tokenhttps = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=%s&secret=%s&code=%s&grant_type=authorization_code";
    // 替换字符串
    ...
    // 3.拉取用户信息的请求地址
    public  String User_Message = "https://api.weixin.qq.com/sns/userinfo?access_token=%s&openid=%s&lang=zh_CN";
    // 替换字符串
